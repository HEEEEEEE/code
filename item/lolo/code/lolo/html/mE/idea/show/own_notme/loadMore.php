		...
		if(!(is_numeric($_POST['idea_id']) && is_numeric($_POST['idea_num']) && is_numeric($_POST['hid']))){
			ajaxreturn('idea id or num or hid check failed');	
		}
		//filter for information filter for information filter for information
		...
		?>
			<div  data-id='<?php echo $html['id']; ?>' id="<?php echo 'IdeA_own'.$html['id']; ?>" data-id='<?php echo $html['id']; ?>' class='idea_own'>
