<link type='text/css' rel='stylesheet' href='<?php echo PROJECTCSSOTHERSDIR."close/album/anima/set.css"?>' />
...
<script src="<?php echo PROJECTJSOTHERSDIR."close/album/anima/set.js"?>"></script>