<link type='text/css' rel='stylesheet' href='<?php echo PROJECTCSSOTHERSDIR."close/album/video/set.css"?>' />
...
<div class='AlbumsM'>
	<div id='AlbumsM_top'>
		...
		<img id='MarK' src="<?php echo PROJECTDATAOTHERSDIR.'close/image/album/toolmenu/valbum.png'?>" />
		</dt>
...
<script src="<?php echo PROJECTJSOTHERSDIR."close/album/video/set.js"?>"></script>