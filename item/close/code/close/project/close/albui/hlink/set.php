<link type='text/css' rel='stylesheet' href='<?php echo PROJECTCSSOTHERSDIR."close/album/hlink/set.css"?>' />
...
<script src="<?php echo PROJECTJSOTHERSDIR."close/album/hlink/set.js"?>"></script>