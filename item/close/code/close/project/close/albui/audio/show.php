...
/*create the album sort*/
		...
		$result=sql("SELECT
			...
			");		
?>
<link type='text/css' rel='stylesheet' href='<?php echo PROJECTCSSOTHERSDIR.'close/album/audio/show.css'; ?>' />
...
<div id="<?php echo 'AlbuM-p'.$html['id']; ?>" class="album-p" style="background-image: url('<?php echo ROOTOTHERSDIR1.$html['face']; ?>')" data-src="<?php echo ROOTOTHERSDIR1.$html['face']; ?>">
	...
	<dt>
	            <a href="">
		<span class="album-p-mark-show" title='Audio for album' style="background-image: url(<?php echo ROOTOTHERSDIR1.'frame/album/audio/mark.png'; ?>)"></span>
		</a>
		<span class="album-p-mark-show-noface" title='add a face' style="background-image: url(<?php echo ROOTOTHERSDIR1.'frame/album/audio/mark.png'; ?>)"></span>
	</dt>
	</dl>	
...
<div id='AlbuM_con_mtmenu'>
	...
	require PROJECTDIR.'close/albui/audio/create.php';
	   ?>
	<?php
	//Include the part the create menu
	require PROJECTDIR.'close/albui/audio/set.php';
	   ?>
	<?php
	//Include the part the create menu
	require PROJECTDIR.'close/albui/audio/delete.php';
	   ?>			   		
</div>							
<script src='<?php echo PROJECTJSOTHERSDIR.'close/album/audio/show.js'; ?>' charset='utf-8'></script>