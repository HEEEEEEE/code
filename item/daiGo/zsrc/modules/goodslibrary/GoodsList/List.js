...
export default class List extends Component {
	...
	deleteRow(key,keyName,rowData){
		...
		// }
		let id = rowData.id;
		this.props.handleDelete(key, keyName, id);
	}
				...
				<View style={styles.hide}>
					<Btn
						...
						onPress={() => {
							...
							this.deleteRow(rowData.id,'id',rowData);
							//this.jumpGoodsDetails(rowData)
                     	}}
					/>
				</View>
				<View style={styles.show}>
					<View style={styles.avatar_view}>
						<Icon name="cubes" size={25} color={colors.Gray}/>
					</View>
					<View style={styles.name_view}>
						<Text style={styles.name_text} numberOfLines={1}>
							{rowData.title || rowData.product_name}
						</Text>
					</View>
				</View>
			</SwipeRow>
		...
		return (
			<View style={styles.container}>
				<SwipeListView
					...
					onRowPress={
						(rowData) => this.jumpGoodsDetails(rowData)
					}
					ref={ e => this._list = e }
